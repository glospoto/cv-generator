...
public class ActionGenerateCvItalianShortNoPrivacy implements Action {
    /* The logger */
    ...
    public ActionGenerateCvItalianShortNoPrivacy() {
        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(ActionGenerateCvItalianShortNoPrivacy.class.getName());
        this.logger.finer("Log for ActionGenerateCvItalianShortNoPrivacy class successfully created");
    ...
    public void execute() {
        ...
        this.controller.generateCvItalianShortNoPrivacy();
