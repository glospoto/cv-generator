...
public class ActionGenerateCvEnglishLongNoPrivacy implements Action {
    /* The logger */
    ...
    public ActionGenerateCvEnglishLongNoPrivacy() {
        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(ActionGenerateCvEnglishLongNoPrivacy.class.getName());
        this.logger.finer("Log for ActionGenerateCvEnglishLongNoPrivacy class successfully created");
    ...
    public void execute() {
        ...
        this.controller.generateCvEnglishLongNoPrivacy();
