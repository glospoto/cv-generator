...
public class SkillSection extends GenericSection {
    /* The template filename */
    protected static final String TEMPLATE_FILENAME = "skill.vm";
    /* The output filename, which will contain the rendered template and will be stored into result/include folder */
    private static final String LATEX_FILENAME = "skill.tex";
    ...
    public SkillSection(String sectionTitle, String language) {
        /* Parent constructor */
        super(sectionTitle, language);

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(SkillSection.class.getName());
        this.logger.finer("Log for SkillSection class successfully created");
     ...
     */
    public String toString() { return SkillSection.class.getName(); }
    ...
    public void build() {
        ...
        this.sectionContent.forEach((entry) -> {
            ...
            SectionEntry sectionEntry = new SkillEntry(
                    entry.get(SkillEntry.TYPE),
            ...
            this.logger.finer("Skill section entry successfully added to the section list");
        });
    ...
    public void render() {
        ...
        template.addToContext(Constant.CTX_SECTION_SKILL, this);
        this.logger.finer("Section skill successfully added to the context");

        /* Render the section */
        template.render(new File(this.fs.getTemplateResultIncludeSectionsDir(), LATEX_FILENAME));
        this.logger.finer("Section skill successfully rendered");
    }
}
