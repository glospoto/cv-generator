...
public class CvItalianShortWithPrivacy extends CvItalian {
    /* The logger */
     ...
     * Constructor
     */
    public CvItalianShortWithPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvItalianShortWithPrivacy.class.getName());
        this.logger.fine("Log for CvItalianShortWithPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvItalianShortWithPrivacy.class.getName(); }
