...
import it.lospoto.model.cv.CvEnglish;
...
public class CvEnglishShortWithPrivacy extends CvEnglish {
    /* The logger */
     ...
     * Constructor
     */
    public CvEnglishShortWithPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvEnglishShortWithPrivacy.class.getName());
        this.logger.fine("Log for CvEnglishShortWithPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvEnglishShortWithPrivacy.class.getName(); }
    ...
    public void build() {
        ...
        factorySection.setLanguage(Constant.ENGLISH);
        this.logger.fine("Language successfully set to " + Constant.ENGLISH + " for all the sections");

        /* Personal info section */
        Section personalInfo = factorySection.createPersonalInfoSection(true);
