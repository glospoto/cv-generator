...
public class CvItalianLongWithPrivacy extends CvItalian {
    /* The logger */
     ...
     * Constructor
     */
    public CvItalianLongWithPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvItalianLongWithPrivacy.class.getName());
        this.logger.fine("Log for CvItalianLongWithPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvItalianLongWithPrivacy.class.getName(); }
