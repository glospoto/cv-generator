...
public class CvEnglishLongNoPrivacy extends CvEnglish {
    /* The logger */
     ...
     * Constructor
     */
    public CvEnglishLongNoPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvEnglishLongNoPrivacy.class.getName());
        this.logger.fine("Log for CvEnglishLongNoPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvEnglishLongNoPrivacy.class.getName(); }
