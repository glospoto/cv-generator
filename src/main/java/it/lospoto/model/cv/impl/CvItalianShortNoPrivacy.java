...
public class CvItalianShortNoPrivacy extends CvItalian {
    /* The logger */
     ...
     * Constructor
     */
    public CvItalianShortNoPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvItalianShortNoPrivacy.class.getName());
        this.logger.fine("Log for CvItalianShortNoPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvItalianShortNoPrivacy.class.getName(); }
