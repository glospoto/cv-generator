...
public class CvEnglishShortNoPrivacy extends CvEnglish {
    /* The logger */
     ...
     * Constructor
     */
    public CvEnglishShortNoPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvEnglishShortNoPrivacy.class.getName());
        this.logger.fine("Log for CvEnglishShortNoPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvEnglishShortNoPrivacy.class.getName(); }
