...
public class CvEnglishLongWithPrivacy extends CvEnglish {
    /* The logger */
     ...
     * Constructor
     */
    public CvEnglishLongWithPrivacy() {
        /* Invoke parent class constructor */
        super();

        /* Create the logger */
        this.logger = FactoryLogger.getInstance().createLogger(CvEnglishLongWithPrivacy.class.getName());
        this.logger.fine("Log for CvEnglishLongWithPrivacy class successfully created");
    }
     ...
     */
    public String toString() { return CvEnglishLongWithPrivacy.class.getName(); }
